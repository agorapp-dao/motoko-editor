...
import { SectionTabs } from '@/src/app/Editor/SectionTabs/SectionTabs';
import { LessonHeader } from '@/src/app/Editor/LessonHeader/LessonHeader';
import { EEditorSectionType } from '@/src/app/constants/editor';
import { ControlPanel } from '@/src/app/Editor/ControlPanel/ControlPanel';
import { SectionCode } from '@/src/app/Editor/Section/Code/SectionCode';
import { SectionLesson } from '@/src/app/Editor/Section/Lesson/SectionLesson';
import { BottomPanel } from '@/src/app/Editor/Panel/BottomPanel/BottomPanel';
import { EditorContext } from '@/src/app/context/EditorContext';
import { SectionTree } from '@/src/app/Editor/Section/Tree/SectionTree';
import { ContentItem } from '@/src/app/Editor/ContentItem/ContentItem';
import { DEMO_COURSE } from '@/src/app/constants/education';
import findLessonRecursively from '@/src/app/utils/findLesson';
